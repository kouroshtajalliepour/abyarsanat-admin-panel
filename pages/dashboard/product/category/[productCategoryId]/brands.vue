...
useHead({
  title: "Admin | Product Category Brand Management",
});
  ...
  inputs: [
    {
      ...
      options: {
        ...
        preDefined: {
          brand_not_included_in_product_category: route.params.productCategoryId
        },
        visibleFields: [
          {
...
const productCategoriesGet = ref({
  ...
  dataResult: "result",
  dataCountResult: "totalCount",
  singleRecordUrl: `/dashboard/product/category/${route.params.productCategoryId}/brand/`,
  preDefined: {
    product_category_id: route.params.productCategoryId,
...
async function submitMove(data:any, selectedRecord:any){
  try {
    ...
    await adminStore.updateData({
      ...
      lang: locale.value,
      url: "/admin/manage/product/product-category-brand",
      useCsrf: false,
...
onBeforeMount(async () => {
  ...
  if (route.params.productCategoryId != 'root') {
    try {
      ...
      links.value.push({
        name: t('links.topLinks.productCategoryBrandManagement'),
        path: `/dashboard/product/category/${route.params.productCategoryId}/brand`,
      })
...
<template>
  <div>
    ...
    <AdminPagesMultiRecordPageTemplate
      ...
      apiBaseUrl="/admin/manage/product/product-category-brand"
      :baseUrl="`/dashboard/product/category/${route.params.productCategoryId}/brand`"
