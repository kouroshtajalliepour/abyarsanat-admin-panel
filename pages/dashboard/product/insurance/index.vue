...
useHead({
  title: "Admin | Product Insurance Management",
});
...
const productsCreate = ref({
  title: t("pages.productInsuranceManagement.createQuote"),
  dataResult: "",
  fieldsToUpload: [],
  preDefined: {},
  inputs: [
...
const productsGet = ref({
  ...
  singleRecordUrl: `/dashboard/product/insurance/`,
  preDefined: {},
  visibleFields: [
    {
...
<template>
  <div>
    ...
    <AdminPagesMultiRecordPageTemplate
      ...
      :baseUrl="`/dashboard/product/insurance`"
