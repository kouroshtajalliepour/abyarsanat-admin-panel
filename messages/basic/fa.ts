...
export default {
    ...
    buttons: {
        ...
        moveToPacking: "انتقال به بسته بندی",
        moveToFinished: "پایان سفارش",
        fileOutput: "دانلود",
        addImage: "افزودن عکس",
        imageInfo: "راهنمای افزودن عکس",
        addLink: "چسباندن لینک",
    ...
    forms: {
        ...
        general: {
            heading: {
                ...
                fileOutput: "هشدار: این عملکرد بسیار سنگین بوده و ممکن است به صورت مقطعی باعث بروز مشکل شود"
            },
            error: {
            ...
            label: {
                ...
                selectedTablePreview: "برای پیش نمایش داده انتخاب شده کلیک کنید",
            },
            placeholder: {
